...
* **Update**: Updated concept `project/overview.md`.
* **Creation**: Documented concept `decisions/security-guard.md` (Pre-Push Git Security Hook).
* **Creation**: Documented concept `architecture/audio-pipeline.md` (Audio & Vocal Production Pipeline).
* **Creation**: Documented concept `project/overview.md` (OpenMontage Core Architecture).
